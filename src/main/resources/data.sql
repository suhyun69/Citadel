...
INSERT INTO BUILDING(NAME, COST, TYPE, COUNT) VALUES ('망루', 1, 'M', 3);
...
INSERT INTO BUILDING(NAME, COST, TYPE, COUNT) VALUES ('감옥', 2, 'M', 3);
INSERT INTO BUILDING(NAME, COST, TYPE, COUNT) VALUES ('병영', 3, 'M', 3);
...
INSERT INTO BUILDING(NAME, COST, TYPE, COUNT) VALUES ('요새', 5, 'M', 2);
...
INSERT INTO BUILDING(NAME, COST, TYPE, COUNT, DESCRIPTION) VALUES ('제국 보고', 5, 'S', 1, '게임이 종료되면 개인 금고에 남아있는 금화 1닢당 1점씩을 추가로 받습니다');
...
INSERT INTO BUILDING(NAME, COST, TYPE, COUNT, DESCRIPTION) VALUES ('공동묘지', 5, 'S', 1, '자기 도시의 아무 건물 1채를 파괴하면 건설비용 지불 없이 공동묘지를 건설할 수 있습니다.');
